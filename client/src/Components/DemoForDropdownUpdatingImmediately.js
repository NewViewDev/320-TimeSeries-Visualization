...
class DemoForDropdownUpdatingImmediately extends React.Component {//manages the various components to handle use case 1
    constructor(props){
        
        super(props);
        this.state = {
            scenarioNameList: ["Test1", "Test2", "TEST3", "test0"], //a list of the name of the scenario
            ...
            <div>
                ...
                {!this.state.loadingScenario && //when we are not loading it produces the acutal result, which is a dropdown of scenarios
                    <div className ='row g-0'>
                        <div>Scenario:</div>
                        <h1> {this.state.scenarioNameList[this.state.selectedScenario]} </h1>
...
export default DemoForDropdownUpdatingImmediately;